...
**NOTE**: You will need to put `vdjdb-motifs` folder locally in this repo before the build process. By default `vdjdb-motifs` is not included in this repository.
