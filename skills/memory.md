...
- `proofreading/imgt_alleles.tsv` (IMGT/GENE-DB release 2026-05-25_GENEDB_202621-7; 4,693 TR gene rows)
- `proofreading/mhc.md`
- `proofreading/mhc_alleles.tsv` (IPD-IMGT/HLA release 3.64.0, 2026-04-16; 46,005 allele rows)
- `skills/memory.md`
...
|---|---|---|
| 2026-05-26 | Use `proofreading/imgt_alleles.tsv` as primary gene authority, with `patches/IGM_nomenclature_table.tsv` as secondary fallback | IMGT/GENE-DB via genedb-releases is more complete and up-to-date; covers all TR genes across all species |
| 2026-05-26 | Use `proofreading/mhc_alleles.tsv` (ANHIG/IMGTHLA) for human HLA validation; use `proofreading/mhc.md` for non-human MHC rules | IMGTHLA is the authoritative source for HLA alleles; non-human MHC is not in IMGTHLA so documented as rules |
